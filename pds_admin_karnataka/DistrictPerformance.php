								...
								<div style="float:right">
                                 ...
                                 <div class="table-responsive">
                                    <table id="export_table" class="table" style="text-align: center;">
                                        <thead>
                                            <tr>
												<th style="font-size:16px; text-align: center;">District</th>
												<th style="font-size:16px; text-align: center;">Total Tags</th>
												<th style="font-size:16px; text-align: center;">Implemented</th>
												<th style="font-size:16px; text-align: center;">Not Implemented</th>
												<th style="font-size:16px; text-align: center;">District Approved</th>
												<th style="font-size:16px; text-align: center;">Not District Approved</th>
												<th style="font-size:16px; text-align: center;">Admin Approved</th>
												<th style="font-size:16px; text-align: center;">Not Admin Approved</th>
                                            </tr>
                                        </thead>
                                        <tbody>
										<?php
										...
										if($result!=NULL or $result!=false){
											...
											if($result!=NULL or $result!=false){
												...
												if($numrows>0){
													...
													{
														echo "<tr>
														<td style='text-align: center;'>{$row['to_district']}</td>
														<td style='text-align: center;'>{$row['total_tags']}</td>
														<td style='text-align: center;'>{$row['implemented_count']}</td>
														<td style='text-align: center;'>{$row['notimplemented_count']}</td>
														<td style='text-align: center;'>{$row['district_approved_count']}</td>
														<td style='text-align: center;'>{$row['notdistrict_approved_count']}</td>
														<td style='text-align: center;'>{$row['admin_approved_count']}</td>
														<td style='text-align: center;'>{$row['notadmin_approved_count']}</td>
													  </tr>";
													}
												}
											}
