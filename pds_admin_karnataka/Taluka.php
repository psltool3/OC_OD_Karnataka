...
<script src="js/Encryption.js"></script>
                    ...
                    <div class="row">
                        <div class="col-md-12">
							...
							<div class="panel-heading">
                                    <h3 class="panel-title">Talukas Data</h3>
                                </div>
								<a href="TalukaAdd.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-success">Add New</button></a> 
                                ...
                                <div class="panel-body">
                                 <div class="table-responsive">
                                    <table id="export_table" class="table">
										...
										$query="SELECT * FROM taluka ORDER BY name";
    ...
    <!-- START SCRIPTS -->
		...
		function edit_entry(temp_id){
			post({uid: temp_id} ,"TalukaEdit.php");
		}
		...
		function VerifyAndDelete(){
			...
			post({uid: temp_id,username:username,password:encrypted} ,"api/TalukaDelete.php");
		}
