...
<script>
	function verifyCaptcha() {
		...
		document.getElementById("password").value = encrypted;
                ...
                <!-- START BREADCRUMB -->
                <ul class="breadcrumb">
                    <li><a href="Taluka.php">Home</a></li>
                    <li class="active">Taluka Add</li>
                </ul>
                <!-- END BREADCRUMB -->
                 ...
                 <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="api/TalukaAdd.php" method="POST" class="form-horizontal" enctype = "multipart/form-data">
                            <div class="panel panel-default">
                               <div class="panel-body">
                                    <p>Fill this form to add new Taluka.</p>
                                </div>
