    ...
    <body>
        ...
        <div class="page-sidebar">
			...
			<ul class="x-navigation">
				<li class="xn-logo">
					<span style="font-size: 19px; text-align: center; margin: 10px;color:#fff">Karnataka State Level</span>
					...
					<div class="profile">
						<div class="profile-data">
							<div class="profile-data-name">
								<!-- <b>Namaste</b> -->
								<b>
									<img src="img/PngItem_1109026.png" alt="Logo" style="vertical-align: middle; height: 60px; width: 100px;" /> Namaste
								</b>
							</div>
						</div>
					</div>
				...
				<li>
					<a href="Taluka.php" style="padding-left:0px"><span class="xn-text" style="font-family:sans-serif;font-weight:italic;font-size:16px;">Edit Taluka</span></a>
				</li>
				<li>
