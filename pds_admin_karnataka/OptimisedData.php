...
<script>
							...
							<div class="row">
								...
								<div class="col-md-3" style="margin-bottom:20px">
									<div class="card h-100"
										...
										<div style="font-size:15px">TOTAL TAGS CHANGE REQUESTED BY DISTRICTS</div>
									</div>
								</div>
								<div class="col-md-3" style="margin-bottom:20px">
									<div class="card h-100"
										...
										<div style="font-size:15px">TOTAL TAGS APPROVED BY ADMIN</div>
									</div>
								</div>
								<div class="col-md-3" style="margin-bottom:20px">
									<div class="card h-100"
										style="background-color:#95b75d; color:white; padding:20px; font-weight: bold;">
										<div style="font-size:25px" id="totalidsagreed"></div>
										<div style="font-size:15px">TOTAL TAGS AGREED BY DISTRICTS</div>
									</div>
								</div>
								<div class="col-md-3" style="margin-bottom:20px">
									<div class="card h-100"
										style="background-color:#FFC167; color:white; padding:20px; font-weight: bold;">
										<div style="font-size:25px" id="totalidspending"></div>
										<div style="font-size:15px">APPROVAL PENDING BY ADMIN</div>
									</div>
								</div>
								<div class="col-md-3" style="margin-bottom:20px">
									<div class="card h-100"
										style="background-color:#A569BD; color:white; padding:20px; font-weight: bold;">
										<div style="font-size:25px" id="totalidsimplemented"></div>
										<div style="font-size:15px">APPROVED TAGS IMPLEMENTED</div>
									</div>
								</div>
							</div>
							</br></br></br>
    ...
    // ✅ Add ONLY the control flag (not a row key)
    modifiedApproveData['accept_all'] = '1';
					...
					success: function(result){
						...
						try{
							...
							for (var datafield in obj) 
							{
								...
								var subpart1 = "<tr><td>" +  obj[datafield]["scenario"] +  "</td><td>"  + obj[datafield]["from"] +  "</td><td>"  + obj[datafield]["from_state"] +  "</td><td>"  + obj[datafield]["from_id"] +  "</td><td>"  + obj[datafield]["from_name"] +  "</td><td>"  + obj[datafield]["from_district"] +  "</td><td>"  + obj[datafield]["from_block"] +  "</td><td>"  + obj[datafield]["from_lat"] +  "</td><td>"  + obj[datafield]["from_long"] +  "</td><td>"  + obj[datafield]["to"] +  "</td><td>"  + obj[datafield]["to_state"] +  "</td><td>"  + obj[datafield]["to_id"] +  "</td><td>"  + obj[datafield]["to_name"] +  "</td><td>"  + obj[datafield]["to_district"] +  "</td><td>"  + obj[datafield]["to_block"] +  "</td><td>"  + obj[datafield]["to_lat"] +  "</td><td>"  + obj[datafield]["to_long"] +  "</td><td>"  + obj[datafield]["commodity"] +  "</td><td>"  + obj[datafield]["quantity"] +  "</td><td>"  + obj[datafield]["distance"] + "</td>";
				...
				$.ajax({
					...
					success: function(result){
						try{
							...
							document.getElementById('totalidsagreed').innerHTML  = resultarray['totalidsagreed'];
							document.getElementById('totalidspending').innerHTML  = resultarray['totalidspending'];
							document.getElementById('totalidsimplemented').innerHTML  = resultarray['totalidsimplemented'];
						}
						catch (error) {
						}
					}
