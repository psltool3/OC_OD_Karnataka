                                        ...
                                        <div class="col-md-6">
											...
											<div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
												   <span class="input-group-addon"><span class="fa fa-arrow-down"></span></span>
                                                     <select class="form-control" id="district" name="district" onChange="fetch_taluka(this.value)">
                                                     </select>
													</div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">ragi Capacity*</label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-info"></span></span>
                                                        <input type="text" class="form-control" id="ragi" name="ragi" value="<?php echo $ragi ?>" required />
                                                    </div>
                                                    <span class="help-block">ragi Capacity</span>
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="col-md-3 control-label">jowar Capacity*</label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-info"></span></span>
                                                        <input type="text" class="form-control" id="jowar" name="jowar" value="<?php echo $jowar ?>" required />
                                                    </div>
                                                    <span class="help-block">jowar Capacity</span>
                                                </div>
                                            </div>
