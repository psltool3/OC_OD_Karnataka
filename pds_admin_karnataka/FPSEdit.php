...
if(isset($_POST["uid"])){
	...
	if($numrows!=0){
		...
		$active = $row['active'];
		$inventory_ragi = $row['inventory_ragi'];
		$inventory_jowar = $row['inventory_jowar'];
	}
	else{
                             ...
                             <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
											...
											<div class="form-group">
                                                <label class="col-md-3 control-label">Demand ragi in Quintals*</label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-info"></span></span>
                                                        <input type="text" class="form-control" id="inventory_ragi" name="inventory_ragi" value="<?php echo $inventory_ragi ?>" required />
                                                    </div>
                                                    <span class="help-block">Demand ragi in Quintals</span>
                                                </div>
                                            </div>
												<div class="form-group">
                                                <label class="col-md-3 control-label">Demand jowar in Quintals*</label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-info"></span></span>
                                                        <input type="text" class="form-control" id="inventory_jowar" name="inventory_jowar" value="<?php echo $inventory_jowar ?>" required />
                                                    </div>
                                                    <span class="help-block">Demand jowar in Quintals</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
