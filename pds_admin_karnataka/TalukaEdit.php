...
$uid = $_POST['uid'];
$query = "SELECT * FROM taluka WHERE id='$uid'";
...
<script>
	function verifyCaptcha() {
		...
		document.getElementById("password").value = encrypted;
                ...
                <ul class="breadcrumb">
                    <li><a href="#">Home</a></li>                    
                    <li class="active">Taluka Edit</li>
                </ul>
                <!-- END BREADCRUMB -->                       
                 ...
                 <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="api/TalukaEdit.php" method="POST" class="form-horizontal">
                            <div class="panel panel-default">
                               <div class="panel-body">
                                    <p>Fill this form to Edit Taluka Name.</p>
                                </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                    ...
                                                    <span class="help-block">Taluka Name</span>
                                                </div>
                                            </div>
