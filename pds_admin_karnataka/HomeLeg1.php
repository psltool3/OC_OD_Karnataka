							...
							<div class="row">
								<div class="col-md-3 mb-4" style="margin-bottom: 20px;">
									<div class="card h-100"
										style="background-color:#4361ee; color:white; padding:12px; font-weight: bold;">
								...
								<div class="col-md-3 mb-4" style="margin-bottom: 20px;">
									<div class="card h-100"
										style="background-color:#f72585; color:white; padding:12px; font-weight: bold;">
								...
								<div class="col-md-4 mb-4" style="margin-bottom: 20px;">
									<div class="card h-100"
										style="background-color:#ff9f1c; color:white; padding:12px; font-weight: bold;">
								...
								<div class="col-md-4 mb-4" style="margin-bottom: 20px;">
									<div class="card h-100"
										style="background-color:#e71d36; color:white; padding:12px; font-weight: bold;">
								...
								<div class="col-md-4 mb-4" style="margin-bottom: 20px;">
									<div class="card h-100"
										style="background-color:#8338ec; color:white; padding:12px; font-weight: bold;">
						...
						.then(data => {
							...
							fetch(pythonUrl + 'getfcidataleg1', {
								...
								.then(data => {
									...
									document.getElementById("total_supply_rice").innerHTML = formatNumberWithCommasWithoutDecimal(data["Total_Supply1"]);
...
function downloadExcelFile() {
    ...
    a.href = url;
    a.download = 'Template_SCO_IntraState_karnataka.xlsx';
    a.click();
...
function downloadFile(fileType) {
    ...
    if (fileType === 'xlsx') {
        filePath = 'template/Template_SCO_IntraState_karnataka.xlsx';
        fileName = 'Template_SCO_IntraState_karnataka.xlsx';
    } else if (fileType === 'pdf') {
        filePath = 'template/Template_SCO_IntraState_karnataka.pdf';
        fileName = 'Template_SCO_IntraState_karnataka.pdf';
    }
		...
		fetch(pythonUrl + 'getGraphDataleg1', {
			...
			.then(data => {
				...
				var month = document.getElementById("month").value;
				   ...
				   document.getElementById("totalFciDemand").innerHTML = "<span style='color: white; font-size: 14px;'>" + "Total Demand Rice: " + formatNumberWithCommas(totalDemand) + " (Qtl)</span>";
				   document.getElementById("totalFciSupply").innerHTML = "<span style='color: white; font-size: 14px;'>" + "Total Supply Rice: " + formatNumberWithCommas(totalCapacity) + " (Qtl)</span>";
               
				   document.getElementById("totalFciDemand1").innerHTML = "<span style='color: white; font-size: 14px;'>" + "Total Demand FRice: " + formatNumberWithCommas(totalDemandRice) + " (Qtl)</span>";
				   document.getElementById("totalFciSupply1").innerHTML = "<span style='color: white; font-size: 14px;'>" + "Total Supply Frice: " + formatNumberWithCommas(totalCapacity1) + " (Qtl)</span>";
				...
				if (totalCapacity > -2 && totalDemand > -2 && totalCapacity1 > -2 && totalDemandRice > -2) {
					if (totalCapacity >= totalDemand && totalCapacity1 >= totalDemandRice) {
...
function checkActiveJob() {
	...
	if(!username) return;
	fetch(pythonUrl + 'active_job?client_id=' + username + '&endpoint=/processFileleg1')
		.then(response => response.json())
		.then(data => {
