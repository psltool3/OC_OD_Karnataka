 ...
 <style>
												...
												while ($row = mysqli_fetch_assoc($result)) {
													...
													echo "<tr>
															...
															<td style='text-align: center;'>
																<button class='btn btn-info btn-rounded' onclick=\"fci_open('{$id_leg1}','{$id_leg1}')\">View FCI</button>
															</td>
															<td style='text-align: center;'>
																<button class='btn btn-warning btn-rounded' onclick=\"warehouse_open('{$id_leg1}','{$id_leg1}')\">View Warehouses</button>
															</td>
															<td style='text-align: center;'>
																<button class='btn btn-danger btn-rounded' onclick=\"optimised_open('{$id_leg1}','{$id_leg1}')\">View Data</button>
															</td>
															<td style='text-align: center;'>
																<button class='btn btn-success btn-rounded' onclick=\"generate_report('{$id_leg1}','{$id_leg1}')\">View Report</button>
															</td>
														</tr>";
												}
											}
    ...
    <!-- START SCRIPTS -->
		...
		function optimised_open(temp_id, leg_id){
			post({id:temp_id,step:"all",legid:leg_id} ,"OptimisedDataView_Leg1.php");
		}
