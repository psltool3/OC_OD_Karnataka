...
<script>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
								<div class="panel-heading">
                                    <h3 class="panel-title">Karnataka PDS Route Optimisation for District - <b><?php echo $district; ?></b> <div id="timer"> <b>Time Left &nbsp </b> <span id="countdown"></span></h3>
                                </div>
                            </div>
							<div class="row">
    ...
    <!-- START SCRIPTS -->
		...
		function saveRow(uniqueId) {
			// Find the value selected for this row
			var boolSelect = document.getElementById(uniqueId + "_bool");
			var value = "";
			if (boolSelect) {
				value = boolSelect.value; // yes, no, or empty
			} else {
			...
			var val = modifiedData[uniqueId]; 
			if (!val) {
				alert("Please select an action (Agree or Change ID) first.");
				return;
			}
			
			params[uniqueId] = val; 
			
			if (val !== "yes" && val !== "same" && val !== "no") {
				var reasonInput = document.getElementById(uniqueId + "_idreason");
				var distanceInput = document.getElementById(uniqueId + "_iddistance");
